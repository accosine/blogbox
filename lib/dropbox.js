...
module.exports.downloadFile = function downloadFile(token, path) {
  return request.get('https://content.dropboxapi.com/2/files/download')
    .set('Dropbox-API-Arg', JSON.stringify({ path: path }))
    .set('Authorization', 'Bearer ' + token)
    .set('Content-Type', '');
}
